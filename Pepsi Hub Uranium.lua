...
--Create Tabs
    ...
    local ToggleAutoFarmLevel = Tabs.Main:AddToggle("ToggleFarmLevel", {Title = "Farm Level", Default = false })
...
spawn(function()
    ...
    local ToggleVatChatKiDi = Tabs.Main:AddToggle("ToggleVatChatKiDi", {Title = "Auto Farm Ectoplasm [ Sea 2]", Default = false })
 ...
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
	...
	spawn(function()
        ...
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Auto Farm Factory [ Sea 2 ]", Default = false })
...
CamShake:Stop()
	...
	task.spawn(function()
        ...
        pcall(function()
          for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
          if not string.find(v.Name,"Boss") and v.Name == MonFarm and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 280 then
