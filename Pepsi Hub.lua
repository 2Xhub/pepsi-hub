...
local Tabs = {
    ...
    Teleport = Window:AddTab({ Title = "Tele", Icon = "palmtree" }),
...
ImageButton.Image = "rbxassetid://16109175835"
...
--Create Tabs
    ...
    local ToggleAutoFarmLevel = Tabs.Main:AddToggle("ToggleAutoFarmLevel", {Title = "Auto Level", Default = false })
...
spawn(function()
	...
	elseif Third_Sea then
		tableBoss = {"Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","Rip_indra","Longma","Soul Reaper","Cake Queen"}
	end
	...
	local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleFarmBoss", {Title = "Kill Boss", Default = false })
...
for _,v in next, workspace.Boats.MarineBrigade:GetDescendants() do
 ...
 AutoW:OnChanged(function(Value)
  ...
  spawn(function()
    ...
    local ToggleHallow = Tabs.Main:AddToggle("ToggleHallow", {Title = "Auto Hallow Scythe [ Beta ]", Default = false })
	...
	spawn(function()
           ...
           local ToggleYama = Tabs.Main:AddToggle("ToggleYama", {Title = "Auto Get Yama [ Beta ]", Default = false })
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Auto Tushita [ Bugs ]", Default = false })
        ...
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Auto Farm Factory [ Beta ]", Default = false })
